...
public class ControllerRecipes extends HttpServlet {
	...
	protected void listarReceitas(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
	...
	protected void visualizarReceita(HttpServletRequest request, HttpServletResponse response)
	    ...
	    //String IDreceitaStr = request.getParameter("receita_id");//verifi
	    int IDreceita = Integer.parseInt(request.getParameter("receita_id"));
	    // Verificando se o parâmetro não é nulo e se é um número válido
	        try {
	            // Convertendo o parâmetro para inteiro
	            //IDreceita = Integer.parseInt(IDreceitaStr);
	...
	protected void VisualizarReceitasNaCategoria(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
